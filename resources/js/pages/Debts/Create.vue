...
// Oy tanlash uchun joriy oyni avtomatik to'ldirish
...
setDefaultMonth(); // Sahifa yuklanganda avtomatik to'ldirish

const submit = () => {
    form.post(route('debts.store'), {
        onSuccess: () => {
            alert("Muvaffaqiyatli! Yangi qarz muvaffaqiyatli qo'shildi.");
            form.reset();
            setDefaultMonth();
        },
        onError: (errors) => {
            alert("Xatolik yuz berdi! Qarzni qo'shishda muammo yuz berdi. Iltimos, ma'lumotlarni tekshiring.");
            console.error('Qarzni qo\'shishda xatolik:', errors);
        },
    });
};
</script>
...
<template>
    <Head title="Yangi Qarz Qo'shish" />
            ...
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center space-x-2">
                    ...
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                        Yangi <span class="text-indigo-600">Qarz Qo'shish</span>
                    </h2>
                </div>
            </div>
        </template>
            ...
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <Card class="rounded-lg shadow-lg border-2 border-slate-200 dark:border-slate-700">
                    <CardHeader class="pb-6">
                        <CardTitle class="text-3xl font-extrabold text-gray-900 dark:text-gray-100">Yangi Qarz Ma'lumotlari</CardTitle>
                        <CardDescription class="text-gray-600 dark:text-gray-400 text-lg">
                            O'quvchi uchun yangi qarzdorlik yozuvini yarating.
                        </CardDescription>
                    </CardHeader>
